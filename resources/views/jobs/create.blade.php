...
<form method="post" action="/jobs">
  ...
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">              
                <input type="text" name="title" id="title" class="block min-w-0 grow py-1.5 pr-3 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Backend Developer" required>
            </div>
      ...
      <div class="mt-10">
        {{-- THIS HANDLES THE ERROR. IT ESSENTIALLY DISPLAYS ALL THE ERROR --}}
            {{-- @if($errors->any())
            <ul>
